...
class _DoaPageState extends State<DoaPage> {
  ...
  static const List<DoaData> _allDoas = [
    ...
    DoaData(
      titleBn: "ক্ষমা চাওয়ার দোয়া",
      titleEn: "Dua for Forgiveness",
      arabic: "أَسْتَغْفِرُ اللَّهَ الَّذِي لاَ إِلَهَ إِلاَّ هُوَ الْحَيُّ الْقَيُّومُ وَأَتُوبُ إِلَيْهِ",
      uccharonBn: "আস্তাগফিরুল্লাহাল্লাজি লা ইলাহা ইল্লা হুয়াল হাইয়্যুল কাইয়্যুম ওয়া আতুবু ইলাইহি",
      uccharonEn: "Astaghfirullahal lazi la ilaha illa Huwal Hayyul Qayyum wa atubu ilaih.",
      meaningBn: "আমি আল্লাহর কাছে ক্ষমা চাই, যিনি ছাড়া কোনো উপাস্য নেই, যিনি চিরঞ্জীব ও চিরস্থায়ী এবং আমি তাঁরই দিকে প্রত্যাবর্তন করছি।",
      meaningEn: "I seek forgiveness from Allah, there is no deity except Him, the Ever-Living, the Sustainer of all existence, and I turn to Him in repentance.",
      categoryBn: "ক্ষমা",
      categoryEn: "Forgiveness",
    ),
    DoaData(
      titleBn: "জাহান্নাম হতে মুক্তির দোয়া",
      titleEn: "Dua for Protection from Hellfire",
      arabic: "اللَّهُمَّ أَجِرْنِي مِنَ النَّارِ",
      uccharonBn: "আল্লাহুম্মা আজিরনী মিনান নার",
      uccharonEn: "Allahumma ajirni minan-nar",
      meaningBn: "হে আল্লাহ! আমাকে জাহান্নামের আগুন থেকে রক্ষা করুন।",
      meaningEn: "O Allah, protect me from the punishment of the Fire.",
      categoryBn: "ক্ষমা",
      categoryEn: "Forgiveness",
    ),
    DoaData(
